    ...
    var YoAds = (function (t) {
        ...
        function (t, e, r) {
            ...
            t.exports = {
                ...
                renderAds(t, e, r) {
                    const { pid: a, aid: o, bnr: s, trk: c, cli: l, web: u, camp: p, advi: d, mdom: h } = e;
                    var f = getComputedStyle(t),
                        m = n.createElement("div", { id: "zones-ads-" + a, style: `position: relative; display: inline-block; width: auto; height: auto; margin: ${f.margin || "auto"}; padding: ${f.padding || "0px"};` });
                    f.maxWidth && (m.style.maxWidth = f.maxWidth);
                    var g = n.createElement("div", { id: "wrapper-ads-" + a, style: `position: relative; display: inline-block; width: ${t.clientWidth}px; height: auto; margin: 0px;` }),
                        y = t.cloneNode(!0);
                    m.appendChild(y), m.appendChild(g);
                    var v = {
                            src: n.generateUrlAd(h, s.ctv.source, a, s, u, o),
                            id: a,
                            style: `width: ${t.clientWidth}px; height: ${t.clientHeight}px; border: none; z-index: 2; position: absolute; margin: auto; left: 0px; right: 0px; bottom: 0px; clip: rect(0px ${t.clientWidth}px ${t.clientHeight}px 0px);`,
                        },
                        _ = n.createElement("iframe", v);
                    g.appendChild(_);
                    var T = {
                            src: n.generateUrlAd(h, s.ctv.slider_source, a, s, u, o),
                            id: "slider-ads-" + a,
                            style: `width: ${t.clientWidth}px; height: ${s.ctv.slider_height}px; border: none; z-index: 2; position: reletive; margin-top: 20px;`,
                        },
                        k = n.createElement("iframe", T);
                    m.appendChild(k), t.parentNode.replaceChild(m, t);
                    const { dom: b, evs: x, ttr: w } = c;
                    var S = new i(b, d, x, w, l, u, p, s, { element: _, duration: 1e3, margin: "0px" });
                    n.addEventListenerHandle(_, "load", function () {
                        S.impression(), S.viewability();
                    }),
                        this.processedAds(a, S, s);
                },
                processedAds(t, e, r) {
                    const i = this;
            ...
            YoAds.showAds(
                {
                    ...
                    camp: {
                        fid: "7f26543512c44de68d3bfef9f039a74c",
                        fln: "In Image Carousel Testing",
                        aid: "2f327cc5217b45f897799dd72c2af650",
                    ...
                    trk: {
                        ...
                        evs: {
                            EVT_IMPRESSION: { id: "002", evt: "9ffb35a788e2a93b4948ddd79e019dfd1663f98a3a" },
                            EVT_START: { id: "003", evt: "9ffb35a788e2a93b4948ddd79e019dfd1663686d52" },
                            EVT_FIRST: { id: "004", evt: "9ffb35a788e2a93b4948ddd79e019dfd16631170eb" },
                            EVT_MID: { id: "005", evt: "9ffb35a788e2a93b4948ddd79e019dfd16637c86fc" },
                            EVT_THIRD: { id: "006", evt: "9ffb35a788e2a93b4948ddd79e019dfd166383a033" },
                            EVT_COMPLETE: { id: "007", evt: "9ffb35a788e2a93b4948ddd79e019dfd166326afb9" },
                            EVT_VIEWABLE: { id: "008", evt: "9ffb35a788e2a93b4948ddd79e019dfd1663be569a" },
                            EVT_CLICK: { id: "009", evt: "9ffb35a788e2a93b4948ddd79e019dfd1663955a74" },
                            EVT_MUTE: { id: "010", evt: "9ffb35a788e2a93b4948ddd79e019dfd1663c7901b" },
                            EVT_UNMUTE: { id: "011", evt: "9ffb35a788e2a93b4948ddd79e019dfd1663ef5d46" },
                            EVT_PAUSE: { id: "012", evt: "9ffb35a788e2a93b4948ddd79e019dfd1663a74e37" },
                            EVT_PLAY: { id: "013", evt: "9ffb35a788e2a93b4948ddd79e019dfd1663a5da1e" },
                            EVT_RESUME: { id: "014", evt: "9ffb35a788e2a93b4948ddd79e019dfd166360bc96" },
                            EVT_SKIP: { id: "015", evt: "9ffb35a788e2a93b4948ddd79e019dfd16634efc14" },
                            EVT_REFRESH: { id: "001", evt: "9ffb35a788e2a93b4948ddd79e019dfd16637973ab" },
                        },
                        ttr: {},
                    },
