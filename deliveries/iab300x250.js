...
function showBannerYomedia_aed6af3371fd4660835b1165f55508f4(s) {
    ...
    if (bannerURL.match(/\.(jpeg|jpg|gif|png)$/) != null) {
        ...
        banner.style.cssText = 'right:0px;left:0px;margin-right:auto;margin-left:auto;display:block;line-height:normal;overflow:hidden;z-index:4999 !important;border:0;width:300px !important;height:250px !important;';
        banner.width = '300';
        banner.height = '250';
    }
...
function impressionTrackingYomedia_aed6af3371fd4660835b1165f55508f4() {
    getTrackingYomedia('https://tracking.yomedia.vn/display?evt=002&token=3c54c5370684d34a09d79c6a90ab7aff224039622b&ord=1616560141438' + Date.now());
    if (typeof _YoImp != 'undefined' && avlHelperModule.validateUrl(_YoImp)) {
        getTrackingYomedia(_YoImp);
    } else if (typeof _YoImpCallback_aed6af3371fd4660835b1165f55508f4 === 'function') {
        _YoImpCallback_aed6af3371fd4660835b1165f55508f4();
    }
}

function viewableTrackingYomedia_aed6af3371fd4660835b1165f55508f4() {
    getTrackingYomedia('https://tracking.yomedia.vn/display?evt=008&token=3c54c5370684d34a09d79c6a90ab7aff22405b7cbf&ord=1616560141438' + Date.now());
}
...
function clickTrackingYomedia_aed6af3371fd4660835b1165f55508f4() {
    if (typeof _YoClick != 'undefined' && avlHelperModule.validateUrl(_YoClick)) {
        ...
        var landingPage = 'https://tracking.yomedia.vn/display?evt=009&token=3c54c5370684d34a09d79c6a90ab7aff2240a40ebf&to=https%3A%2F%2Fyomedia.vn&ord=1616560141438' + Date.now();
...
function getClickTagYomedia_aed6af3371fd4660835b1165f55508f4() {
    var landingPage = '';
    landingPage = 'https://tracking.yomedia.vn/display?evt=009&token=3c54c5370684d34a09d79c6a90ab7aff2240a40ebf&to=https%3A%2F%2Fyomedia.vn&ord=1616560141438' + Date.now();
    return landingPage;
}
...
//flight: Yomedia Server Testing IAB 300x250 PC
