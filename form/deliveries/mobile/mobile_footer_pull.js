...
var yomediaId_1936d003c150434a8f90e7e97ee11377 = 'yomedia-wrapper-mobile-pull-1936d003c150434a8f90e7e97ee11377';
var yomediaContentId_1936d003c150434a8f90e7e97ee11377 = 'yomedia-mobile-content-pull-1936d003c150434a8f90e7e97ee11377';
var iOS_1936d003c150434a8f90e7e97ee11377 = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;

var min_w_1936d003c150434a8f90e7e97ee11377 = (384 != 0)?384:screen.width;
var min_h_1936d003c150434a8f90e7e97ee11377 = (300 != 0)?300:screen.height;
var max_w = (0 != 0)?0:screen.width;
var max_h = (0 != 0)?0:screen.height;

var ratio_1936d003c150434a8f90e7e97ee11377 = 220/660;
if (384 && 300) {
    ratio_1936d003c150434a8f90e7e97ee11377 =  parseInt(300) / parseInt(384);
}
...
function showBannerYomedia_1936d003c150434a8f90e7e97ee11377(s) {
    ...
    if (bannerURL) {
        ...
        var creative_src = `https://${domainURL}.yomedia.vn/${bannerURL}?pid=1936d003c150434a8f90e7e97ee11377&aid=b99b5de8d8aa44ba83af6629bb06c449&fid=494344c32be84bac8513d9e50ea89fc7&advId=c23b9c109f7a4f89a3cb23f694f1d7cb&campId=d6692db2a2dd441c9ab9741ee05b127d&pubId=5565e302fb2e489cae28103f6c66db12&chanId=3d58e13cbef3493682fe6107ac13e262&clk=` + clickTag;
...
function minYoMediaPopupAd_1936d003c150434a8f90e7e97ee11377() {
    ...
    var rect_top = Math.ceil(document.getElementById('yz-1936d003c150434a8f90e7e97ee11377').clientHeight * ratio_1936d003c150434a8f90e7e97ee11377);
    banner.style.clip = 'rect(' + (document.getElementById('yz-1936d003c150434a8f90e7e97ee11377').clientHeight - rect_top) + 'px, ' + document.getElementById('yz-1936d003c150434a8f90e7e97ee11377').clientWidth + 'px, ' + document.getElementById('yz-1936d003c150434a8f90e7e97ee11377').clientHeight + 'px, 0px)';
}

function setYoMediaPre_1936d003c150434a8f90e7e97ee11377() {
    var banner = document.getElementById(yomediaContentId_1936d003c150434a8f90e7e97ee11377);
    banner.style.clip = 'rect(0px, ' + document.getElementById('yz-1936d003c150434a8f90e7e97ee11377').clientWidth + 'px, ' + ocument.getElementById('yz-1936d003c150434a8f90e7e97ee11377').clientHeight + 'px, 0px)';
}
