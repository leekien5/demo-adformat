...
function showBannerYomedia_1936d003c150434a8f90e7e97ee11377(s) {
  ...
  var width = (400 != 0) ? 400 : window.innerWidth;
  var height = (250 != 0) ? 250 : 250;
  var banner_height = window.innerWidth * parseInt(height) / parseInt(height);
  const zone_ads = document.createElement('div');
  zone_ads.id = `yz-${pid}`;
  zone_ads.style.cssText = `width: 100%; height: ${banner_height}px; position: fixed; bottom: 0px; z-index: 2147483500 !important;`;
  ...
  const creative_src =`https://${domainURL}.yomedia.vn/${bannerURL}?pid=1936d003c150434a8f90e7e97ee11377&aid=a4daa66a304b4f2e8798c44b7ef10100&fid=d1e1bb6bc5824af990679c70c69cfc92&advId=c23b9c109f7a4f89a3cb23f694f1d7cb&campId=d6692db2a2dd441c9ab9741ee05b127d&pubId=5565e302fb2e489cae28103f6c66db12&chanId=3d58e13cbef3493682fe6107ac13e262&clk=` + clickTag;
